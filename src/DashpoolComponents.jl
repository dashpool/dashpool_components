...
function __init__()
    ...
    external_url = "https://unpkg.com/dashpool_components@0.0.89/dashpool_components/dashpool_components.js",
    dynamic = nothing,
    async = nothing,
    type = :js
),
DashBase.Resource(
    ...
    external_url = "https://unpkg.com/dashpool_components@0.0.89/dashpool_components/dashpool_components.js.map",
    dynamic = true,
    async = nothing,
    type = :js
)
