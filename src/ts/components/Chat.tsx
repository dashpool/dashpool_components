                    ...
                    >
                        <span
                            ...
                            onClick={() => {
                                ...
                                if (referenceTarget && referenceTarget != "" && referenceMessage.data.url) {
                                    window.open(referenceMessage.data.url, referenceTarget);
                                }
...
const toChatMessage = (message: any, referenceMessages: Map<string, any>, setProps: any, dashpoolEventOnClick: any, referenceTarget: any) => {
    ...
    if (message.role === "assistant") {
        return {
            position: 'left',
            type: 'text',
            text: <MarkdownWrapper content={message.content} referenceMessages={referenceMessages} setProps={setProps} dashpoolEventOnClick={dashpoolEventOnClick} referenceTarget={referenceTarget} />,
...
const Chat = (props: ChatProps) => {
    ...
    let { dashpoolEventOnClick, referenceTarget } = props;

    if (dashpoolEventOnClick === undefined || dashpoolEventOnClick === null) {
        dashpoolEventOnClick = true;
    }
    ...
    const [chatMessages, setChatMessages] = useState<ChatMessageType[]>(messages.map((message) => toChatMessage(message, referenceMessages, setProps, dashpoolEventOnClick, referenceTarget)));
    ...
    const setCombinedMessage = (message: any) => {
        ...
        setChatMessages((prevMessages) => [
            ...prevMessages,
            toChatMessage(message, referenceMessages, setProps, dashpoolEventOnClick, referenceTarget),
        ]);
    ...
    const handleNewUserMessage = async (newMessage) => {
        ...
        setChatMessages((prevMessages) => [
            ...prevMessages,
            toChatMessage({ role: 'user', content: newMessage }, referenceMessages, setProps, dashpoolEventOnClick, referenceTarget),
        ]);
        ...
        setChatMessages((prevMessages) => [
            ...prevMessages,
            toChatMessage({ role: 'typing' }, referenceMessages, setProps, dashpoolEventOnClick, referenceTarget),
        ]);
